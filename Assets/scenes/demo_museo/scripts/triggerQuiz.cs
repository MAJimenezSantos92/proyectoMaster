...
public class triggerQuiz : MonoBehaviour {
	...
	void Start () {
		...
		client.Subscribe(new string[] { "museo/androidCall" }, new byte[] { MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE }); 
	...
	void OnTriggerEnter(Collider c){
		 ...
		 client.Publish("museo/androidCall", System.Text.Encoding.UTF8.GetBytes("quizAndroid"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
         }else{ 
