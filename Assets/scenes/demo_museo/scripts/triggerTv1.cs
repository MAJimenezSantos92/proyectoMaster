...
public class triggerTv1 : MonoBehaviour {
	...
	void Start () {
		...
		client.Subscribe(new string[] { "museo/tv1" }, new byte[] { MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE }); 
		
		client.Publish("museo/tv1", System.Text.Encoding.UTF8.GetBytes("tv1"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
...
/* 		if(topic.Equals("RFID1 ON")){
	...
	void OnTriggerEnter(Collider c){
		 ...
		 client.Publish("museo/androidCall", System.Text.Encoding.UTF8.GetBytes("tvAndroid"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
         }else{ 
