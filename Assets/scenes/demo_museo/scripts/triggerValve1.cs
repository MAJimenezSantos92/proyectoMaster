...
public class triggerValve1 : MonoBehaviour {
	...
	void Start () {
		...
		client.Subscribe(new string[] { "museo/valve1" }, new byte[] { MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE }); 
		
		client.Publish("museo/valve1", System.Text.Encoding.UTF8.GetBytes("valve1"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
...
/* 		if(topic.Equals("RFID1 ON")){
	...
	void OnTriggerEnter(Collider c){
		 ...
		 client.Publish("museo/androidCall", System.Text.Encoding.UTF8.GetBytes("valveAndroid"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
         }else{ 
