...
public class triggerZerg1: MonoBehaviour {
	...
	void Start () {
		...
		client.Subscribe(new string[] { "museo/zerg1" }, new byte[] { MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE }); 
		
		client.Publish("museo/zerg1", System.Text.Encoding.UTF8.GetBytes("zerg1"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
...
/* 		if(topic.Equals("RFID1 ON")){
	...
	void OnTriggerEnter(Collider c){
		 ...
		 client.Publish("museo/androidCall", System.Text.Encoding.UTF8.GetBytes("zergAndroid"), MqttMsgBase.QOS_LEVEL_EXACTLY_ONCE, true);
         }else{ 
